//==========================================================================
// Gimbal Clock - LenticularClock.ino
//
...
#define LEFT_ARROW 0x6E // 'n'
#define RIGHT_ARROW 0x6D // 'm'
...
{
  Serial.begin(9600);
  Serial.print("Gimbal Clock version 1.0\n");
  ...
  if (!wm.autoConnect("GimbalClockAP")) {
